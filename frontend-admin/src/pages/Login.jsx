        ...
        <div className="bg-surface rounded-2xl border border-border-default shadow-[0_8px_40px_rgba(35,70,213,0.08)] overflow-hidden">
          <div className="bg-gradient-to-br from-primary to-primary-container px-8 py-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-white font-display-md text-2xl font-bold tracking-tight">FlickTickets</h1>
              <p className="text-white/70 text-xs font-label-sm uppercase tracking-widest mt-1">
                Trang quản trị rạp phim
              </p>
            </div>
          </div>
          ...
          <div className="px-8 py-8">
            <div className="mb-6">
              <h2 className="font-headline-sm text-headline-sm text-text-primary font-semibold">Đăng nhập</h2>
              <p className="text-text-secondary text-body-md mt-1">Chỉ dành cho quản trị viên được cấp quyền</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              <div>
                ...
                <div className="relative group">
                  <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-text-muted text-[20px] group-focus-within:text-primary transition-colors">mail</span>
                  <input
                    id="email"
                    type="email"
                    autoComplete="email"
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-text-primary mb-1.5">Mật khẩu</label>
                <div className="relative group">
                  <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-text-muted text-[20px] group-focus-within:text-primary transition-colors">lock</span>
                  <input
                    id="password"
          ...
          <div className="px-8 pb-6 text-center">
            <div className="flex items-center gap-2 justify-center text-text-muted">
              ...
              <p className="text-xs">Kết nối được mã hóa · Chỉ tài khoản quản trị viên mới được phép đăng nhập</p>
            </div>
          </div>
        </div>

        <p className="text-center text-text-muted text-xs mt-4">
          FlickTickets Quản trị viên v1.0 &copy; {new Date().getFullYear()}
        </p>
      </div>
    </div>
  );
